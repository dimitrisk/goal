...
## ----  warning=F, message=F, fig.cap =c("one","two","three"), results='asis', fig.height=5----
library(knitr)
...
## ----   warning=F, results='asis', fig.height=5-------------------------------
result = goal::uav.DoReduction(one, insize=10)

## ----   warning=F, fig.cap =c("Results points"), results='asis', fig.height=5----
par(mar=c(0, 0, 3, 0))
