...
Get all roads of this municipality:
```{r}
myr1 = osm.getRoads(inPerioxi = "Mytilene Municipal Unit", withBB=FALSE, outcrs = 2100)
myr1

myr2 = osm.getRoads(incoordinates = c(26.545029,39.088569,26.570177,39.116810), withBB=TRUE, outcrs = 2100 )
myr2
```
